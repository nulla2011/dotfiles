# Generated by Powerlevel10k configuration wizard on 2022-03-09 at 20:28 CST.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 64001.
# Wizard options: awesome-fontconfig, small icons, lean_8colors, ascii, 24h time,
# 2 lines, solid, white-ornaments, compact, concise, instant_prompt=verbose.
